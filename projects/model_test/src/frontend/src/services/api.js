/** The only module that talks to the backend. Components never call fetch. */
...
export const getServing = () => request('/serving');
export const startServing = (modelId) => request('/serving', { method: 'POST', body: { model_id: modelId } });
export const stopServing = () => request('/serving', { method: 'DELETE' });
export const getServingLogs = (tail = 120) => request(`/serving/logs${query({ tail })}`);
