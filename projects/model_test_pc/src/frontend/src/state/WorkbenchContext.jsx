...
export function WorkbenchProvider({ children }) {
  ...
  const submitPrompt = useCallback(async () => {
    ...
    const payload = { model_id: selectedModelId, prompt, system_prompt: systemPrompt, parameters, images };
  ...
  }, [images, parameters, prompt, scheduleCommit, selectedModel, selectedModelId, systemPrompt]);
  ...
  const value = useMemo(() => ({
    ...
    schema, parameters, systemPrompt, prompt, images, answer,
    ...
    addImages, removeImage, loadRuns, deleteRun, loadJudges,
  }), [models, providers, modalityFilter, selectedProvider, selectedModelId, selectedModel, modelsError, schema,
    parameters, systemPrompt, prompt, images, answer, runs, runsFilter, runsError, judges, notice,
